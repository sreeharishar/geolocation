...
char myssid[] = "Get Your Own Damn Wi-Fi";         // your network SSID (name)
char mypass[] = "244466666";          // your network password


//Credentials for Google GeoLocation API...
const char* Host = "www.googleapis.com";
String thisPage = "/geolocation/v1/geolocate?key=";
String key = "AIzaSyDC7sgzS1F5iqhUmbF0zyIhfEHMkmi58uU";
